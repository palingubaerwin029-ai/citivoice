...
const styles = StyleSheet.create({
  ...
  sortOptionText: { color: COLORS.textSecondary, fontSize: rf(14) },
  ...
  filterText: { color: COLORS.textMuted, fontSize: rf(11), fontWeight: "700" },
  filterCount: { color: COLORS.textMuted, fontSize: rf(10), fontWeight: "800" },
  ...
  cardMeta: { color: COLORS.textMuted, fontSize: rf(11) },
  upvotes: {
    color: COLORS.accent,
    fontSize: rf(11),
    fontWeight: "700",
  ...
  cardDate: { color: COLORS.textMuted, fontSize: rf(10), marginTop: verticalScale(8) },

  empty: { alignItems: "center", paddingVertical: verticalScale(60) },
  emptyText: { color: COLORS.textMuted, marginTop: verticalScale(12), fontSize: rf(15) },
});
