      ...
      <View style={styles.content}>
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: rf(10), color: colors.textMuted }}>
                  {Number(concern.location_lat).toFixed(6)},{' '}
                  {Number(concern.location_lng).toFixed(6)} • Tap for Google Maps
                </Text>
              </View>
        ...
        >
          ...
          {concern.admin_note && !saved && (
            ...
            >
              <Text style={[styles.prevNoteLabel, { color: colors.accent }]}>
                PREVIOUS RESPONSE
              </Text>
              <Text style={[styles.prevNoteText, { color: colors.textPrimary }]}>
                {concern.admin_note}
              </Text>
            </View>
          )}
