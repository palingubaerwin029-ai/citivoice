...
const styles = StyleSheet.create({
  ...
  locationText: { color: COLORS.textPrimary, fontSize: 13, flex: 1 },
  ...
  savedText: { color: COLORS.accent, fontSize: 14, fontWeight: "700" },
  ...
  prevNoteText: { color: COLORS.textPrimary, fontSize: 13, lineHeight: 20 },
});
