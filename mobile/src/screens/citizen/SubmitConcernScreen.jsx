            ...
            <View style={styles.stepContainer}>
              ...
              >
                ...
                <View style={styles.reviewRow}>
                  ...
                  >
                    <Text style={[styles.reviewValue, { color: colors.textPrimary, flex: 0 }]}>
                      {form.category || 'None'}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.reviewRow}>
                  ...
                  <Text
                    style={[styles.reviewValue, { color: colors.textPrimary }]}
                    numberOfLines={1}
                  >
                    {form.title || 'None'}
                  </Text>
                ...
                <View style={styles.reviewRow}>
                  ...
                  <Text
                    style={[
                      styles.reviewValue,
                      { color: imageUri ? colors.accent : colors.textMuted },
                    ]}
                  >
                    {imageUri ? '✅ Attached' : '❌ None'}
                  </Text>
                </View>
                <View style={styles.reviewRow}>
                  <Text style={[styles.reviewLabel, { color: colors.textSecondary }]}>
