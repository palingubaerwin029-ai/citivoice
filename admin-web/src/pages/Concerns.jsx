      ...
      <div className={styles.header}>
        <div>
          ...
          <p className={styles.pageSubtitle}>
            {filtered.length} of {concerns.length} concerns shown
          </p>
        </div>
      </div>
        ...
        <div className={styles.filterRow}>
          <div className={styles.searchBox}>
            ...
            <input
              ...
              placeholder="Search by title, citizen, or barangay..."
              value={search}
        ...
        <div className={styles.tableCard}>
            ...
            <tbody>
              {filtered.map((c) => (
                ...
                >
                  ...
                  <td className={styles.td}>{c.userBarangay}</td>
                  <td className={styles.td}>
                    <span
                      ...
                      style={{
                        ...
                        backgroundColor:
                          (PRIORITY_COLORS[c.priority] || "#8899BB") + "22",
                      }}
                    >
                      {c.priority === "High"
                        ? "🔴"
                  ...
                  <td className={styles.td}>
                    <span
                      ...
                      style={{
                        ...
                        backgroundColor:
                          (STATUS_COLORS[c.status] || "#8899BB") + "22",
                      }}
                    >
                      {c.status}
                    </span>
                  ...
                  <td
                    className={styles.td}
                    style={{ color: "#00D4AA", fontWeight: 700 }}
                  >
                    👍 {c.upvotes || 0}
                  </td>
          ...
          {filtered.length === 0 && (
            <div className={styles.emptyState}>
              ...
              <p className={styles.emptyText}>No concerns match your filters</p>
            </div>
          )}
        </div>
      )}
